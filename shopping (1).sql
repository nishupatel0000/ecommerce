...
INSERT INTO `product` (`product_id`, `name`, `description`, `image`, `price`, `additional_description`, `gender`, `cat_id`, `color_id`) VALUES
(1, ' Alpha Cotton Shirt', 'A breathable, 100% cotton shirt designed for everyday comfort. Features a relaxed fit with reinforced stitching and a soft collar to ensure lasting durability and a polished look.\r\n\r\n', 'kCEOmKhtWR.jpg', 1600, 'Ideal for both casual Fridays at the office and weekend brunches. Available in multiple colors. Washes well without fading. Pre-shrunk to maintain size after multiple washes.', 'male', 1, 4),
(2, 'Trendix Checked Shirt', 'A stylish checkered shirt crafted from a premium cotton-poly blend. The blue and green pattern gives it a vibrant, youthful look perfect for casual occasions or laid-back office environments.', 'WXKVNkBacF.jpg', 700, 'Includes a front pocket, wooden-style buttons, and adjustable cuff buttons. Easy to iron and keeps its shape all day. Great for layering or wearing on its own.', 'female', 1, 1),
(3, 'Nova Formal Shirt', 'Tailored for the modern professional, this formal shirt features a sleek silhouette, narrow collar, and matte finish. Designed with breathable fabric that keeps you cool during long meetings.', 'OzgLJNtECh.jpg', 200, 'Pair it with dress pants or a blazer for a complete look. Moisture-wicking and odor-resistant technology helps keep you fresh through the day. French cuffs add an elegant touch.', 'baby', 1, 7),
(18, 'Classic Denim Jeans', 'A pair of timeless denim jeans designed for comfort and style. Crafted with a blend of cotton and elastane for the perfect fit.', 'JWYbcRduHZ.jpg', 1200, 'Available in a variety of sizes ranging from 28 to 36 and three stylish colors: Dark Blue, Black, and Light Wash. These jeans are versatile enough for casual wear or dressing up for an evening out. The high-quality fabric ensures durability and breathability, making them comfortable all day long. Featuring a classic fit with a medium rise, they offer just the right amount of stretch to move with you. Machine washable for easy maintenance, these jeans will maintain their shape and color even after multiple washes. The perfect addition to any wardrobe!', 'male', 2, 4),
