          ...
          <form method="POST">
              ...
              <?php
                foreach ($ranges as $range) {
                    ...
                    echo "
                        <div class=\"custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3\">
                            <input type=\"checkbox\" class=\"custom-control-input\" id=\"$id\" name=\"price_range[]\" value=\"$value\">
                            <label class=\"custom-control-label\" for=\"$id\">$range_label</label>
      ...
      <div class="bg-light p-4 mb-30">
          <form>
              <?php
                ...
                ?>
                  <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                      <input type="checkbox" class="custom-control-input" id="<?php echo $id; ?>" name="gender[]" value="<?php echo $gender; ?>">
