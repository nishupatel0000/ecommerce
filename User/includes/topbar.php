                ...
                <div class="d-inline-flex align-items-center">
                    <div class="profile-dropdown">
                        <div class="profile-toggle">
                            ...
                            ?>
                                <span class="profile-name">Hi, John <i class="fa fa-caret-down"></i></span>
        ...
        <div class="modal-box">
            ...
            <div class="right-box">
                ...
                <form id="loginForm" action="login.php" method="POST">
                    <input type="email" name="email" placeholder="Enter Email or Mobile" required><br>
    ...
    $.ajax({
      ...
      success: function(data) {
        if (data.code == 200) {
          ...
          window.location.href = "dashdboard.php";
        } else {
